...
const TeaItem = ({ name, id, description }: { name: string, id: string, description: string }) => {
  ...
  return (
    <div className="group flex flex-col items-center gap-4 text-center border border-border/50 rounded-2xl p-8 h-full transition-all duration-300 hover:shadow-xl hover:scale-105 bg-card">
