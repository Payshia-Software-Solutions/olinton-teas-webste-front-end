...
export default function BulkPackagingSection() {
    ...
    return (
        <section id="packaging" className="py-20 md:py-28 bg-background">
                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-8 items-center">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        <div className="space-y-4 text-left">
                            ...
                            <p className="text-muted-foreground pt-4">
                                MJF Exports (Pvt.) Ltd focusses on providing an efficient and reliable service to bulk tea importers around the world who prefer to work with superior quality teas.
                            </p>
                            <Button variant="outline" className="border-primary text-primary hover:bg-primary/10">Read More</Button>
                        </div>
                        <div className="relative aspect-square p-4 border-2 border-accent/50">
                            {bulkImage && (
                                <Image
                                    src={bulkImage.imageUrl}
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        ...
                        <div className="relative aspect-square p-4 border-2 border-accent/50">
                            {privateLabelImage && (
                                <Image
                                    src={privateLabelImage.imageUrl}
