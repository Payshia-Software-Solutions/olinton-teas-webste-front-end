            ...
            <div className="space-y-8">
              <div className="bg-card p-6 rounded-lg shadow-sm border">
                ...
                <div className="flex gap-4">
                    ...
                    <Button type="submit" variant="secondary" form="checkout-form" disabled={!form.watch('discountCode')}>Apply</Button>
                </div>
                 <Separator className="my-6" />
              ...
              <Button type="submit" form="checkout-form" className="w-full bg-primary hover:bg-primary/90 text-lg py-6">Place the order</Button>
            </div>
          </div>
        </div>
      </main>
